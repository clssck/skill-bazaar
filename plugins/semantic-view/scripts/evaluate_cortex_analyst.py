#!/usr/bin/env python3
"""
Helper script for Cortex Analyst evaluations.
...
def main():
    parser = argparse.ArgumentParser(
        description="Cortex Analyst evaluation helper — upload configs and run evaluations",
    )
    ...
    upload_parser.add_argument(
        "--stage",
        required=True,
        help="Fully qualified stage name (e.g., MYDB.MYSCHEMA.METRICS)",
    )
