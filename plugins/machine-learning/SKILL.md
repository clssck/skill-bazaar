...
| "create inference service", "inference endpoint", "serve model", "snowpark container services", "model endpoint", "deploy in container", "deploy model service", "real-time inference", "online inference", "A/B gateway", "traffic split", "champion challenger", "canary deployment", "create gateway", "gateway", "split traffic", "route traffic between models" | `spcs-inference/SKILL.md` | Load immediately, create SPCS service |
...
| A/B testing & version comparison | SPCS Inference (create gateway) + Inference Logs (analyse results) |
